...
@section('content')
    <div class="row">
        <div class="col-12 col-lg-6">
            <!-- Default box -->
            <div class="card">
                <form method="POST" action="{{ route('materials.update', $data->id) }}">
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="date" id="date_input" name="date_input"
                                ...
                                value="{{ old('date_input', $data->date_input) }}" required />
                            @error('date_input')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="price" name="price"
                                ...
                                value="{{ old('price', number_format($data->price, 0, '', '.')) }}" required oninput="formatNumber(this)" />
                            @error('price')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
